    ...
    >
      <div className="mb-8 lg:hidden">
        <img
          src={Brand}
          alt="Logo Materially"
          className="object-cover w-55 mx-auto"
        />
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-3 cursor-pointer top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 rounded"
          ...
          <div className="flex justify-end">
            <a
              ...
              className="text-xs text-gray-500 hover:text-blue-600 focus:underline transition-colors"
            >
              Esqueceu a senha?
            </a>
          </div>
        ...
        <Button
          ...
          className="h-11 w-full cursor-pointer rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors"
        >
